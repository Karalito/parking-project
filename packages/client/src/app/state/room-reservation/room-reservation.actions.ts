...
export const addRoomReservation = createAction(ActionTypes.ADD_ROOM_RESERVATION_ATTEMPT, props<{ userId: string; roomId: string; hardwareId: string; date: Moment }>());
...
export const addRoomReservationFailure = createAction(ActionTypes.ADD_ROOM_RESERVATION_FAILURE, props<{error: IError}>());
...
export const deleteRoomReservationFailure = createAction(ActionTypes.REMOVE_ROOM_RESERVATION_FAILURE, props<{error: IError}>());
...
export const getRoomReservationFailure = createAction(ActionTypes.GET_ROOM_RESERVATIONS_FAILURE, props<{error: IError}>());
